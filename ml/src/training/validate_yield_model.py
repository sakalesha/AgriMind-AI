...
def run_validation():
    ...
    try:
        ...
        print(f"Warning: Some crops were not found in the encoder: {e}")
    ...
    with open(report_path, 'w', encoding='utf-8') as f:
        ...
        if r2 < 0.7:
            f.write("> [!CAUTION]\n")
            f.write("> The R2 score dropped significantly compared to the training R2. This is a strong indicator of Synthetic Data Bias.\n\n")
        elif r2 < 0.9:
            f.write("> [!WARNING]\n")
